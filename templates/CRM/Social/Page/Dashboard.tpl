<div class="social-wrapper">
  {if !isset($facebookPageConnected) && !isset($twitterConnected) }
    <div class="social-box">
      <div class="box-item">
        No social network has been connected. Go to <a href="{crmURL p='civicrm/admin/social/networks}">Network Settings</a> and connect one or more social networks.
      </div>
    </div>
  {else}
    {if $facebookPageConnected eq '1'}
      <div class="container stats">
        <div class="social-box-inline">  
          <div class="box-item">
            <div class="image">
