 ...
 */
class CRM_Social_Page_Facebook_ConnectPage extends CRM_Core_Page {
  ...
  public function run() {
    ...
    if (!$isEnabled) {
      ...
      $redirectUrl = CRM_Utils_System::url("civicrm/admin/social/appcredentials?continue={$currentUrl}", NULL, TRUE);
    ...
    if (isset($_POST['page_id'])) {
      ...
      $currentUrl = rawurlencode(CRM_Utils_System::url('civicrm/admin/social/network/connect/facebookpage', NULL, TRUE));
      CRM_Utils_System::redirect(CRM_Utils_System::url("civicrm/admin/social/network/connect/facebookpage/list?continue={$currentUrl}", NULL, TRUE));
    }
  }
  ...
  private function getPermissions($permissions = array()) {
    $facebook = new CRM_Social_OAuthProvider_Facebook();
    $currentUrl = CRM_Utils_System::url('civicrm/admin/social/network/connect/facebookpage', NULL, TRUE);
