...
class CRM_Social_Page_Dashboard extends CRM_Core_Page {
  ...
  public function run() {
    ...
    CRM_Core_Resources::singleton()->addScriptFile('biz.jmaconsulting.social', 'templates/res/js/dashboard.js');
    parent::run();
  }
