 ...
 */
class CRM_Social_Page_Twitter_Connect extends CRM_Core_Page {
  ...
  public function run() {
    ...
    $currentUrl = CRM_Utils_System::url('civicrm/admin/social/network/connect/twitter', NULL, TRUE);
    $twitter = new CRM_Social_OAuthProvider_Twitter();
