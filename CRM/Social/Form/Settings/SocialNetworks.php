 ...
 */
class CRM_Social_Form_Settings_SocialNetworks extends CRM_Core_Form {
  ...
  public function buildQuickForm() {
    ...
    $session = CRM_Core_Session::singleton();
    $currentUrl = rawurlencode(CRM_Utils_System::url('civicrm/admin/social/networks', NULL, TRUE));
    ...
    CRM_Core_Resources::singleton()->addScriptFile('biz.jmaconsulting.social', 'templates/res/js/social-networks-setting.js');
