 ...
 * @copyright CiviCRM LLC (c) 2004-2016
 *
 * Social User BAO class.
 */
class CRM_Social_BAO_SocialUser extends CRM_Social_DAO_SocialUser {
   ...
   *
   * @return array
   *   CRM_Batch_BAO_SocialUser object on success, null otherwise
   */
  public static function retrieve(&$params, &$defaults) {
    $socialUser = new CRM_Social_DAO_SocialUser();
    $socialUser->copyValues($params);
    if ($socialUser->find(TRUE)) {
      CRM_Core_DAO::storeValues($socialUser, $defaults);
      return $socialUser;
    }
    return NULL;
  }
  ...
  public static function create($params) {
    ...
    CRM_Utils_Hook::pre($op, 'SocialUser', CRM_Utils_Array::value('id', $params), $params);
    $socialUser = new CRM_Social_DAO_SocialUser();
    $socialUser->copyValues($params);
    $socialUser->save();
    CRM_Utils_Hook::post($op, 'SocialUser', $socialUser->id, $socialUser);
    return $socialUser;
  }
